...
import { getCommentsForOnePost } from "../../redux/actions/postsAction";
...
const Comments = ({ id }) => {
  ...
  useEffect(() => {
    dispatch(getCommentsForOnePost(id));
  }, [dispatch, id]);

  const { loadingCommentsForOnePost, comments } = useSelector(
    (state) => state.getCommentsForOnePost
  );
  ...
  const editSubmitHandler = () => {
    if (selectedComment) {
      ...
      dispatch(updateComment(selectedComment._id, editedComment, id));
    }
  ...
  return (
    <Box>
      {loadingUpdateComment === true || loadingDeleteComment === true ? (
        <Box
          sx={{
            display: "flex",
            alignItems: "center",
        ...
        <Box>
          ...
          >
            ...
            <Button
              ...
              onClick={(e) => commentSubmitHandler(e)}
